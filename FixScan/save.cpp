    ...
    ui(new Ui::save)
{
	...
	ui->label_9->hide();*/
	ui->checkBox__save_with_mesh->setCheckState(Qt::Checked); ///<Ä¬ÈÏÑ¡ÖÐ
	ui->checkBox__save_with_mesh->setVisible(false);
	ui->checkBox_Sasc->setVisible(false);
}
...
void save::on_pushButton_clicked()
{
	...
	bool sasc = false/*ui->checkBox_Sasc->isChecked()*/;
